    ...
    RouterModule.forChild([
      ...
      { path: 'child9', component: Child9Component },
      {
        ...
        /*
            ...
            ChildrenComponent 컴포넌트 그 화면 내부에 router-outlet 설정이 존재합니다.
            이 곳에 어떤 컴포넌트를 배치할 지 추가적인 설정이 필요합니다.
         */
        children: [
          {
      ...
      },
      {
        ...
        children: [
          {
            /*
            { path: 'child7', component: Child7Component, canActivate: CanActivateChildGuardService}

            children Component 영역 하부에 사용하는 자식 컴포넌트들이
            화면에 배치되기 전에 공통되므로 처리해야 하는 로직이 있다면
            canActivateChild 가드로 실행할 수 있습니다.
             */
            path: '',
